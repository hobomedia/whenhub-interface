...
export abstract class Signalling {
    ...
    protected sessionChannel: string;
    protected metadataChannel: string;
    protected userIdKey: string;
    protected userNameKey: string;
    protected textMessageKey: string;
    protected createConnection: any;
    protected onReceivedText: any = null;
    protected client: any = null;
    protected Connections: fm.icelink.ConnectionCollection;

    public constructor(serverUrl: string, name: string, sessionId: string, createConnection: any) {
    ...
    public joinAsync(): fm.icelink.Future<Object> {
        ...
        try {
            ...
            this.client = (window as any).client = new fm.websync.client(this.serverUrl);
            this.client.setDomainKey(new fm.icelink.Guid('b0e15424-ba55-489d-b62a-1d6e1aa5927d'));
...
export class ManualSignalling extends Signalling {
    ...
    public constructor(serverUrl: string, name: string, sessionId: string, createConnection: any) {
        super(serverUrl, name, sessionId, createConnection);
    }
...
export class AutoSignalling extends Signalling {
    ...
    protected defineChannels(): void {
        this.sessionChannel = "/auto-signalling/" + this.sessionId;
        this.metadataChannel = this.sessionChannel + "/metadata";
    }
