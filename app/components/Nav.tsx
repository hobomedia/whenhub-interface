...
export default class Nav extends React.Component<any, {menuClick: string}> {
    ...
    buttonDisplay(){
        if(this.props.button == "menu"){
            ...
            <i className="fa fa-bars" style={{paddingTop: "10px"}}></i></a>
        </button>
            ...
            <i className="fa fa-angle-left" style={{paddingTop: "10px"}}></i></a>
        </button>
        }
        return
    }
            ...
            <div>
                <div className={styles.bar} style={{position: 'relative', top: '0px', width: '338px', height: '40px', backgroundColor: '#37d3b4', color: 'white' }}>
                    {this.buttonDisplay()}
                        ...
                        <div style={{display: "inline", width: "50%", margin: " 8pt 0 Auto", textAlign: "center", position: "absolute"}}>
                            {this.props.page}
                        </div>
                        {/* {this.next()} */}
                </div>
